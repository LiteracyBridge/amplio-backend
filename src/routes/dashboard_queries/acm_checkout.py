...
from ...utilities.rolemanager.Roles import *    # type: ignore
from ...utilities.rolemanager import manager    # type: ignore
...
def do_query(params, claims):
    def has_access(program: str, admin_targets: list):
    ...
    programs = manager.get_programs_for_user(email)
    ...
    for checkout in checkouts:
        if has_access(cannonical_acm_project_name(checkout.get('acm_name')), admin_targets):
