...
def canonical_acm_path(
    acm: str, dropbox: Union[bytes, str, os.PathLike] = DROPBOX_PATH
) -> Path:
    """
...
def canonical_acm_name(acm: str) -> Union[str, None]:
    """
...
def canonical_acm_program_name(acmdir: str) -> Union[str, None]:
    """
